    ...
    <Container>
      <FlexContainer>
        ...
        <Text as="p" variant="sm" sx={styles.text}>
          CosmicX Foundation (hereinafter CosmicX) is aware of the importance of personal data privacy and user rights.
          For this reason, we have implemented a personal data protection policy aimed at providing security and
          transparency for our users when using the CosmicX website, cosmicx.finance (hereinafter “the Site”). The use
        ...
        <Text as="p" variant="sm" sx={styles.text}>
          CosmicX Foundation, Suite 102, Cannon Place, P.O. Box 712, North Sound Rd., Grand Cayman, KY1-9006.
        </Text>
        <Heading>II. Name and address of the Data Processing Manager:</Heading>
        <Text as="p" variant="sm" sx={styles.text}>
          The entity in charge of data processing and protection of information gathered in the Site is CosmicX
          Foundation.
        </Text>
        ...
        <Heading>V. Information CosmicX Collects from you:</Heading>
        <Text as="p" variant="sm" sx={styles.text}>
        ...
        <Text as="p" variant="sm" sx={styles.list}>
          CosmicX will not process any of the data registered with MoonPay.
          <br />
        ...
        <Text as="p" variant="sm" sx={styles.list}>
          CosmicX will not process any of the data registered with Torus Labs.
        ...
        <Text as="p" variant="sm" sx={styles.text}>
          CosmicX grants you a limited right to use the Site. Your right to use the Site is subject to your agreement to
          abide by these Terms and Conditions in their entirety, as well as any other rules, procedures, policies, terms
          or conditions that govern all or any portion of the Site. At any time and for any reason CosmicX may revoke
        ...
        <Text as="p" variant="sm" sx={styles.text}>
          ...
          privacy@cosmicx.finance with the subject line: &quot;Data Rights&quot;. Include your name and we will contact
