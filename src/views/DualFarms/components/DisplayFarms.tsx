        ...
        cardContent: (
          <Flex sx={styles.cardContent}>
            <ListViewContent
              ...
              toolTip={t(
                'APY includes annualized COSMIC rewards and rewards for providing liquidity (DEX swap fees), compounded daily.',
              )}
            ...
            <Flex sx={{ ...styles.onlyDesktop, maxWidth: '180px', width: '100%' }}>
              <ListViewContent
                ...
                toolTip={t(
                  'COSMIC reward APRs are calculated in real time. DEX swap fee APRs are calculated based on previous 24 hours of trading volume. Note: APRs are provided for your convenience. APRs are constantly changing and do not represent guaranteed returns.',
                )}
