    ...
    <SwiperProvider>
      <Flex sx={styles.mainContainer}>
        <ListViewLayout>
          <Banner
            banner="auction"
            link="https://cosmicx.gitbook.io/apeswap-finance/product-and-features/collect/nfa-auction-house"
            title={t('Nfa Auction')}
            maxWidth={1130}
          />
          <Flex sx={{ width: '100%', justifyContent: 'center', marginTop: '20px' }}>
            <MoreInfoWrapper>
              <Button size="sm" style={{ marginRight: '10px', height: '36px' }}>
                <a
                  href="https://cosmicx.gitbook.io/apeswap-finance/product-information/non-fungible-apes-nfas/nfa-auction-house"
                  target="_blank"
