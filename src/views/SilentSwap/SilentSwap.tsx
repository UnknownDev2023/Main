...
import CardSilentSwap from './SilentSwapCard'
...
const CardFull = styled(BaseLayout)<{ isMobile: boolean }>`
  ...
  .column-full {
    ...
    border: ${(props) => props.isMobile && '2px solid #3c817f'};
  }
`
