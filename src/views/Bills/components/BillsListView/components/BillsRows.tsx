      ...
      listProps: {
        ...
        infoContent: (
          <Tooltip
            ...
            secondURLTitle={t('View Certificate Contract')}
        ...
        cardContent: isMobile ? (
          <DiscountContent
            title={t('Discount')}
            valueColor={disabled ? null : parseFloat(bill?.discount) < 0 ? '#3c817f' : '#38A611'}
          ...
          >
            <Flex sx={{ width: '100%', maxWidth: '130px', ml: '10px' }}>
              <DiscountContent
                ...
                value={disabled ? 'N/A' : `${bill?.discount}%`}
                value2={disabled ? '' : bill?.priceUsd}
                toolTip={t(`Percentage discount relative to the token's current market price.`)}
                showToolTipPrice={parseFloat(bill?.priceUsd) < 0.001}
                flexDirection="column"
              />
            </Flex>
            <ListViewContent
              ...
              toolTip={t('Time period for vesting all tokens in the certificate.')}
            ...
            <ListViewContent
              ...
              toolTip={t('Available tokens for purchase.')}
              toolTipPlacement="bottomLeft"
              ...
              <Flex sx={{ width: '100%', justifyContent: 'center', flexWrap: 'wrap' }}>
                <Flex sx={{ flexWrap: 'wrap', padding: '0 10px 10px 10px', width: '100%', flexDirection: 'column' }}>
                  <ListViewContent
                    ...
                    toolTip={`Time period for vesting all tokens in the certificate.`}
                    toolTipPlacement={'bottomLeft'}
                    toolTipTransform={'translate(39%, 0%)'}
