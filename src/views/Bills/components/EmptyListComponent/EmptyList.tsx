    ...
    <Flex sx={styles.mainContainer}>
      <Flex sx={styles.subContainer}>
        ...
        <Flex sx={styles.title}>
          <Text color="gray">
            {type === EmptyComponentType.AVAILABLE_BILLS &&
              t(`All Certificates on ${NETWORK_LABEL[chainId]} are sold out.`)}
            {type === EmptyComponentType.USER_BILLS && t(`You don't have any certificates`)}
        ...
        <Text size="12px" sx={{ marginTop: '15px', opacity: '.5', textAlign: 'center' }}>
          ...
          {type === EmptyComponentType.USER_BILLS && t('Click below to purchase your first certificate')}
        </Text>
