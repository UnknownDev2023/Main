    ...
    <Container>
      <Header>
        ...
        {isMobile ? (
          ...
          <GridCardsContainer>
            <TranslucidCard>
              <CardLabel>{`COSMIC ${t('Balance')}`}</CardLabel>
            ...
            <TranslucidCard>
              <Flex alignItems="center" marginBottom="2px" style={{ gap: '6px' }}>
                ...
                <Tooltip content="The total USD value of tokens staked across all CosmicX products from the connected wallet.">
