        ...
        <div>
          ...
          {position.isAuto ? (
            ...
            <CardValue
              ...
              fontSize="14px"
              fontWeight={700}
              suffix={position.rewardToken ? position.rewardToken.symbol : 'COSMIC'}
            />
          )}
        ...
        {position.isAuto ? (
          ...
          <>
            <CardValue
              ...
              fontWeight={700}
              value={position.rewardBalance}
              suffix={position.rewardToken ? position.rewardToken.symbol.toUpperCase() : 'COSMIC'}
            />
            {position.secondaryRewardBalance ? (
              <CardValue
                fontSize="14px"
  ...
  return (
    <CardInfo>
      ...
      <Content isOpen={isOpen}>
        ...
        <div style={{ width: '100%', marginTop: '10px', borderRadius: '0px', overflow: 'hidden' }}>
