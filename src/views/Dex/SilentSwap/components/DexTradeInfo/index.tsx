      ...
      >
        ...
        <Flex>
          ...
          >
            ...
            >
              {isBonusRouter ? t('Bonus Router') : isSmartRouter ? t('Smart Router') : t('CosmicX Router')}
            </Text>
          </Flex>
                    ...
                    body={
                      <Text size="12px" weight={500} sx={{ lineHeight: '10px' }}>
                        {isBonusRouter
                          ...
                          : isSmartRouter
                          ? t(
                              'The router used to facilitate transactions through other DEXs if CosmicX’s DEX cannot fulfill them.',
                            )
                          : t('The native router that powers the majority of trades on the CosmicX DEX.')}
                      </Text>
                    }
                    placement="topRight"
