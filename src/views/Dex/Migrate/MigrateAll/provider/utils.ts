...
/**
 * Helper function to set the initial status of both Migrate LPs and CosmicX LPs if they exist
 * This function should only run on render and when user LPs have been loaded
 * @param migrateLps List of Migrate LPs
 * @param apeswapLps List of CosmicX LPs
 * @param farms List of CosmicX Farms to check allowances
 * @param vaults List of CosmicX Vaults to check allowances
