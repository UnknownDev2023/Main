 ...
 * @param farms List of CosmicX farms
 * @param vaults List of CosmicX vaults
...
/**
 * Hook to set a callback to update the users CosmicX LP balances after compelting a migrate
 * @param apeswapLpBalances List of CosmicX LP balances
 * @param lpStatus List of Migrate LPs status
 * @param liquidityTokens List of Pair and PairStates
 * @param setLpStatus Action to set the Migrate LP Status state
 * @param setApeswapLpBalances Action to set the CosmicX LP Balances
 */
...
/**
 * Hook to get the users CosmicX LPs for the migration
 */
