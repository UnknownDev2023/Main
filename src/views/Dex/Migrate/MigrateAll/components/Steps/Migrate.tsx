    ...
    return {
      ...
      cardContent: !isMobile ? (
        <>
          ...
          <ListViewContent title={t('COSMIC LP')} value={matchedApeLps?.balance?.toSignificant(6) || '0'} ml={20} />
  ...
  return (
    <Flex sx={{ flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
      ...
      <Text size="12px" weight={500} mb="15px">
        {t(
          'Migrate all of your newly unstaked LPs from other protocols over to CosmicX. By default, slippage is set to 5%',
        )}
      </Text>
