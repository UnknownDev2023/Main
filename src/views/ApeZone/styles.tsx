...
export const Header = styled.div`
  ...
  background-image: ${({ theme }) =>
    theme.isDark ? 'url(/images/banners/cosmicx-mobile-dark.svg)' : 'url(/images/banners/cosmicx-mobile-light.svg)'};
  height: 278px;
  ...
  ${({ theme }) => theme.mediaQueries.sm} {
    background-image: ${({ theme }) =>
      theme.isDark ? 'url(/images/banners/cosmicx-dark-968.svg)' : 'url(/images/banners/cosmicx-light-968.svg)'};
    height: 300px;
  ...
  ${({ theme }) => theme.mediaQueries.xl} {
    background-image: ${({ theme }) =>
      theme.isDark ? 'url(/images/banners/cosmicx-dark-bg.svg)' : 'url(/images/banners/cosmicx-light-bg.svg)'};
  }
`
