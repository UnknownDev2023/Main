          ...
          <Flex sx={styles.legendContainer}>
            <Flex sx={{ alignItems: 'center', flexWrap: 'no-wrap', margin: '4px 0px' }}>
              ...
              <Flex sx={{ alignItems: 'center', justifyContnet: 'center' }}>
                ...
                <TooltipBubble
                  body={<Text>{t('Capital that CosmicX has on hand to use for DAO expenses.')}</Text>}
                  width="200px"
            ...
            <Flex sx={{ alignItems: 'center', flexWrap: 'no-wrap', margin: '4px 0px' }}>
              ...
              <Flex sx={{ alignItems: 'center', justifyContnet: 'center' }}>
                ...
                <TooltipBubble
                  body={<Text>{t('Total value of the liquidity that CosmicX owns in the form of LP tokens.')}</Text>}
                  width="180px"
                  transformTip="translate(25px, 0px)"
                >
                  <Svg icon="info" width="13px" />
            ...
            <Flex sx={{ alignItems: 'center', flexWrap: 'no-wrap', margin: '5px 0px' }}>
              ...
              <Flex sx={{ alignItems: 'center', justifyContnet: 'center' }}>
                ...
                <TooltipBubble
                  body={
                    <Text>{t('Total value of the liquidity that CosmicX Partners own in the form of LP tokens.')}</Text>
                  }
                  width="180px"
                  transformTip="translate(25px, 0px)"
                >
