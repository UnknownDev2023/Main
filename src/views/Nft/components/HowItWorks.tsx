    ...
    <StyledHowItWorks>
      <Section>
        ...
        <Row>
          ...
          <Text>
            {t(
              "Winners can trade in their NFTs for a COSMIC value until the expiry date written below. If you don't trade in your NFT by then, don’t worry: you’ll still keep it in your wallet!",
            )}
          </Text>
        </Row>
      </Section>
