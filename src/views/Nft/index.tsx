    ...
    <>
      <Page>
        <Banner
          ...
          link="https://cosmicx.gitbook.io/apeswap-finance/product-and-features/collect/non-fungible-apes-nfas"
          title={t('Nfa Collection')}
          margin="0 0 20px 0"
        />
        <StyledHero>
          <Text style={{ color: 'subtle', paddingTop: '10px', textDecoration: 'underline' }}>
            <StyledAnchor href="https://cosmicx.finance/staking" target="_blank" rel="noopener noreferrer">
