      ...
      <Flex sx={styles.nfbCon}>
        <Flex sx={styles.nfbTextCon}>
          <Text sx={styles.nfbHeader}>
            {!holdsBab
              ? t('The 30-Day CosmicX BAB NFB Raffle')
              : wonPrize && account
          ...
          <Text sx={styles.nfbDescription}>
            ...
            {wonPrize && account
              ? t('Thank you for joining the CosmicX BAB Club and participating in our BAB Launch Raffle!')
              : t(
                  `From October 1st through October 31st, all holders of an CosmicX BAB NFT will be eligible to participate in a daily raffle to win a Non Fungible Banana NFT.`,
                )}
            <br />
            <br />
            {wonPrize && account
