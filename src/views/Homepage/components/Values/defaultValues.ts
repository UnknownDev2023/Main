...
export const defaultValues: (t: ContextApi['t']) => Values[] = (t) => [
  {
    ...
    link: 'https://cosmicx.gitbook.io/apeswap-finance/welcome/im-new-here',
  },
  {
    ...
    link: 'https://cosmicx.gitbook.io/apeswap-finance/welcome/mission-and-vision',
  },
  {
    title: t('Security'),
    ...
    link: 'https://cosmicx.gitbook.io/apeswap-finance/where-dev/security',
  },
]
