...
export const apiV2BaseUrl = process.env.REACT_APP_API_V2_BASE_URL || 'https://api-v2.cosmicx.finance'
...
const EXCHANGE_SUBGRAPH_URL = 'https://graph.cosmicx.finance/subgraphs/name/ape-swap/apeswap-subgraph'
...
export const useChartData = (resolution = '60', pair = 'COSMIC/BUSD') => {
