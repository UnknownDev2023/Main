      ...
      activate(connector, async (error: Error) => {
        if (error instanceof UnsupportedChainIdError) {
          ...
          if (error instanceof NoEthereumProviderError || error instanceof NoBscProviderError) {
            toastError(t("Browser Error: Please use a crypto wallet app's built-in browser to connect to CosmicX."), {
              text: 'Learn More',
              url: 'https://cosmicx.gitbook.io/apeswap-finance/product-and-features/wallets/how-to-use-apeswap-on-mobile-devices',
            })
          } else if (
