...
export const COSMIC_PER_BLOCK = new BigNumber(10)
export const BLOCKS_PER_YEAR = new BigNumber(10512000)
export const BLOCKS_PER_DAY = new BigNumber(28800)
export const SECONDS_PER_YEAR = new BigNumber(31536000)
export const COSMIC_PER_YEAR = COSMIC_PER_BLOCK.times(BLOCKS_PER_YEAR)
export const BSC_BLOCK_TIME = 3
export const COSMIC_POOL_PID = 1
export const BASE_EXCHANGE_URL = 'https://cosmicx.finance'
