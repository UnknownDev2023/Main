...
export const BSC: { [key: string]: Token } = {
  ...
  COSMIC: new Token(ChainId.BSC, '0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95', 18, 'COSMIC', 'ApeSwapFinance COSMIC'),
...
export const MATIC: { [key: string]: Token } = {
  ...
  COSMIC: new Token(ChainId.MATIC, '0x5d47bAbA0d66083C52009271faF3F50DCc01023C', 18, 'COSMIC', 'BananaToken'),
...
export const TLOS: { [key: string]: Token } = {
  ...
  // COSMIC: new Token(ChainId.TLOS, '', 18, 'COSMIC', 'ApeSwapFinance COSMIC'),
}
...
export const MODAL_INFO = {
  sellModal: {
    title: 'Selling COSMIC?',
    supporting: 'Before You Sell...',
    description: 'Have you tried these products?',
  },
  buyModal: {
    title: "You've Got COSMIC!",
    supporting: "Now You're Ready...",
    description: 'Put your new COSMIC to work!',
  },
  generalHarvestModal: {
    title: "You've Earned COSMIC!",
    supporting: 'Did You Know?',
    description: 'You can use your COSMIC to earn more rewards:',
  },
  poolHarvestModal: {
    title: "You've Earned COSMIC!",
    supporting: 'Did You Know?',
...
export const CTA_CARD_INFO = {
  maximizers: {
    ...
    destination: 'https://cosmicx.finance/maximizers',
  },
  pools: {
    title: 'Pools',
    description: 'Discover the next gem',
    destination: 'https://cosmicx.finance/pools',
  },
  lending: {
    title: 'Lending',
    description: 'Supply, borrow, and earn',
    destination: 'https://lending.cosmicx.finance',
  },
  gnana: {
    title: 'Gnana',
    description: 'Unlock exclusive utility',
    destination: 'https://cosmicx.finance/cosmicx',
  },
  compound: {
    title: 'Compound',
