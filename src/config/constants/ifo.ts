...
const ifos: (t: ContextApi['t']) => Ifo[] = (t) => [
  ...
  },
  {
    ...
    description: t(
      'ApeRocket is building a suite of products that provide automated yield optimization strategies for BNB Chain leveraging CosmicX liquidity.',
    ),
    launchDate: 'May. 25',
    launchTime: '03:00 UTC',
