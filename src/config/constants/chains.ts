...
export const NETWORK_INFO_LINK: Partial<Record<ChainId, string>> = {
  [ChainId.BSC]: 'https://info.cosmicx.finance',
  [ChainId.BSC_TESTNET]: 'https://info.cosmicx.finance',
  [ChainId.MATIC]: 'https://polygon.info.cosmicx.finance/',
  [ChainId.MATIC_TESTNET]: 'https://polygon.info.cosmicx.finance/',
  [ChainId.MAINNET]: 'https://ethereum.info.cosmicx.finance',
  [ChainId.TLOS]: 'https://telos.info.cosmicx.finance',
}
...
export const FULL_PRODUCT_NAMES: Record<LIST_VIEW_PRODUCTS | OTHER_PRODUCTS, string> = {
  [LIST_VIEW_PRODUCTS.BILLS]: 'Certificates',
  [LIST_VIEW_PRODUCTS.MAXIMIZERS]: 'Banana Maximizers',
  [LIST_VIEW_PRODUCTS.JUNGLE_FARMS]: 'Space Farms',
  [LIST_VIEW_PRODUCTS.POOLS]: 'Pools',
  [LIST_VIEW_PRODUCTS.FARMS]: 'Farms',
  [OTHER_PRODUCTS.COSMICX]: 'COSMICX',
