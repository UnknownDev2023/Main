    ...
    <Box className="boxCon" sx={{ padding: '20px 20px 20px 20px' }}>
      <Flex sx={{ flexDirection: 'column' }}>
        <Text sx={{ textAlign: 'center' }}>
          ...
          <br />
          {t(
            'The CosmicX DEX is decentralized, meaning that anyone can create or add liquidity for a token. Unlisted tokens have not been reviewed by CosmicX or passed our due diligence process. Unlisted tokens may present scam risks, including the loss of funds.',
          )}
          <br />
          <br />
