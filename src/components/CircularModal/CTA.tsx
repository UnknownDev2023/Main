...
const CTA_CARDS = {
  ...
  buyModal: {
    ...
    2: <CTACard type={CTA_TYPE.COSMICX} action={MODAL_TYPE.BUYING} />,
  },
  generalHarvestModal: {
    ...
    2: <CTACard type={CTA_TYPE.COSMICX} action={MODAL_TYPE.GENERAL_HARVEST} />,
  },
  poolHarvestModal: {
    ...
    2: <CTACard type={CTA_TYPE.COSMICX} action={MODAL_TYPE.POOL_HARVEST} />,
  },
}
