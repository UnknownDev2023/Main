        ...
        <Flex sx={gnanaStyles.headsUpHeader}>
          ...
          <Flex sx={{ padding: '2px', fontSize: ['14px'] }}>
            <Text sx={gnanaStyles.headsUpDescription}>
              {t(
                'Buying COSMICX involves paying a 28% burn fee and a 2% reflect fee for a total cost of 30%. This means that for every 1 COSMIC you trade in, you will receive 0.7 COSMICX.',
              )}
            </Text>
          </Flex>
          ...
          <Button
            ...
            onClick={() => window.open('https://cosmicx.finance/cosmicx', '_blank')}
          >
        ...
        <Flex sx={{ flexDirection: 'column' }}>
          ...
          <Flex sx={{ marginTop: '20px', alignItems: 'center' }}>
            ...
            <Text sx={gnanaStyles.checkboxText}>
              {t('I understand how COSMICX works and I want to enable unlimited buy')}
            </Text>
          </Flex>
        </Flex>
