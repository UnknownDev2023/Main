      ...
      <>
        <Modal minWidth="360px" maxWidth="600px">
          <Flex sx={{ width: 'auto', height: 'auto', justifyContent: 'center', flexDirection: 'column' }}>
            ...
            >{`Due to recent events causing increased legal scrutiny throughout the DeFi industry, CosmicX has been given no choice but to restrict select regions from accessing our offerings. You are receiving this notice, because it appears you are visiting from a restricted region, ${geoLocation.countryCode}.`}</Text>
            <br />
