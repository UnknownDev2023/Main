    ...
    <Flex sx={{ flexDirection: 'column' }}>
      ...
      <Flex sx={{ margin: '22px 0 0 0', '@media screen and (min-width: 852px)': { margin: '22px 0 0 63px' } }}>
        <Text size="12px" weight={500}>
          ...
          {t('Certificates have a limited supply and will sell out. Check out the ')}
          <InnerTextButton
            href="https://cosmicx.gitbook.io/apeswap-finance/product-and-features/raise/certificates"
            target="_blank"
