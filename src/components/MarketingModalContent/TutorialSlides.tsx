    ...
    <Slide
      ...
      slideContent={
        <>
          ...
          <Text sx={{ fontStyle: 'italic' }}>
            <Text sx={styles.content}>{t('Keep in mind CosmicX uses three different routers (')}</Text>
            <TooltipBubble
              placement={'topRight'}
              transformTip={`translate(${isMobile ? '9%' : '5%'}, 2%)`}
              body={
                <Flex sx={styles.tipBody}>
                  {t("CosmicX's primary DEX router that facilitates token swaps through native liquidity sources.")}
                </Flex>
              }
            ...
            <TooltipBubble
              ...
              body={
                <Flex sx={styles.tipBody}>
                  {t("CosmicX's router that facilitates token swaps through external sources of liquidity.")}
                </Flex>
              }
            ...
            <TooltipBubble
              ...
              body={
                <Flex sx={styles.tipBody}>
                  {t(
                    "CosmicX's router that finds backrunning strategies and returns a Swap Bonus when arbitrage is identified.",
                  )}
                </Flex>
              }
...
export const PoolSlides = () => {
  ...
  return [
    <Slide
      ...
      slideContent={
        <>
          <Text>{t('Select GET COSMIC or GET COSMICX to acquire tokens to stake.')}</Text>
          <Text>
            ...
            <TooltipBubble
              ...
              body={
                <Flex sx={styles.tipBody}>
                  {t("CosmicX's governance token that also enables access to exclusive pools and IAO allocations")}
                </Flex>
              }
              sx={{ width: ['210px', '210px', '350px'] }}
            >
              <Text sx={styles.tipTitle}>COSMICX,</Text>
            </TooltipBubble>{' '}
            {t("you'll need to get COSMIC First!")}
          </Text>
        </>
      }
    />,
  ...
  return [
    <Slide
      ...
      slideContent={
        <>
          <Text>
            {t(
              'Open the desired Maximizer and click GET LP or GET COSMIC. This will allow you to easily obtain tokens to stake.',
            )}
          </Text>
          <Text sx={{ fontStyle: 'italic', fontWeight: 300 }}>
            {t('⚡NEW: You can also')}{' '}
    ...
    <Slide
      ...
      slideContent={
        <>
          <Text>
            {t(
              `Once you have the LP tokens or COSMIC, ENABLE your desired Maximizer and then click DEPOSIT to stake and start earning.`,
            )}
          </Text>
        </>
      }
    ...
    <Slide
      ...
      slideContent={
        <>
          <Text>
            {t("You'll see your COSMIC rewards balance grow over time. Both the 'AUTO' and 'MAX' Vaults will")}{' '}
            <TooltipBubble
              placement={'topRight'}
              transformTip={`translate(${isMobile ? '10%' : '0'}, 2%)`}
              body={
...
export const GnanaSlides = () => {
  ...
  return [
    <Slide
      key={1}
      step="Step 1"
      slideTitle="Get COSMIC"
      slideContent={
        <>
          <Text>
            {t('In order to convert into COSMICX, you must first hold COSMIC.')}{' '}
            <Text sx={styles.yellow}>
              <a href="https://cosmicx.finance/swap" target="_blank" rel="noreferrer noopener">
                {t('Click here')}
              </a>
            </Text>{' '}
            {t('to trade any of your tokens for COSMIC!')}
          </Text>
        </>
      }
    />,
    <Slide
      ...
      slideContent={
        <>
          <Text>
            {t(
              'Input the desired amount of COSMIC you would like to convert, and select CONVERT. Then, confirm the transaction in your wallet.',
            )}
          </Text>
        </>
      }
    ...
    <Slide
      ...
      slideContent={
        <>
          <Text>
            {t('Converting from COSMIC to COSMICX involves paying a 28% burn fee and a 2%')}{' '}
            <TooltipBubble
              placement={'topLeft'}
              transformTip={`translate(${isMobile ? '10%' : '0'}, 2%)`}
              body={
          ...
          <Text sx={{ fontStyle: 'italic' }}>
            <Text sx={styles.content}>{t('(For every 1 COSMIC you convert, you will receive 0.7 COSMICX)')}</Text>
          </Text>
        </>
      }
    />,
    <Slide
      ...
      slideContent={
        <>
          <Text>
            {t('Enjoy your new, shiny COSMICX! You can now access exclusive pools, hold them to earn')}{' '}
            <TooltipBubble
              placement={'topLeft'}
              transformTip={`translate(${isMobile ? '10%' : '0'}, 2%)`}
              body={
            ...
            {t('or participate in COSMICX IAOs.')}
          </Text>
          <Text sx={{ fontStyle: 'italic' }}>
            ...
            <Text sx={styles.yellow}>
              <a
                href="https://discuss.cosmicx.finance/?_ga=2.192308074.1948993264.1666625902-2101162031.1664826138"
                target="_blank"
      ...
      slideContent={
        <>
          <Text>
            ...
            {t('(or both!). Select GET BNB or GET COSMICX to acquire the tokens you need.')}
          </Text>
          <Text sx={{ fontStyle: 'italic' }}>
      ...
      slideContent={
        <>
          <Text>
            ...
            <Text sx={styles.yellow}>
              <a href="https://cosmicx.finance/banana-farms" target="_blank" rel="noreferrer noopener">
                {t('Yield Farms')}
              </a>
            </Text>{' '}
            {t(' or ')}{' '}
            <Text sx={styles.yellow}>
              <a href="https://cosmicx.finance/maximizers" target="_blank" rel="noreferrer noopener">
                {t('COSMIC Maximizers')}
              </a>
            </Text>{' '}
...
export const MigrateSlides = () => {
  ...
  return [
    ...
    <Slide
      key={3}
      step="Step 3"
      slideTitle="Migrate LPs To CosmicX"
      slideContent={
        <>
          <Text>
            {t(
              'Select APPROVE ALL to approve the CosmicX migration contracts. Then, select MIGRATE ALL to move your LPs over to CosmicX. Confirm all the transactions in your wallet.',
            )}
          </Text>
    ...
    <Slide
      key={4}
      step="Step 4"
      slideTitle="Stake In CosmicX"
      slideContent={
        <>
          <Text>
            {t(
              'Select APPROVE ALL and then STAKE ALL to stake all your tokens in CosmicX products. Confirm all the transactions in your wallet.',
            )}
          </Text>
          <Text sx={{ fontStyle: 'italic', fontWeight: 300 }}>
    ...
    <Slide
      ...
      slideContent={
        <>
          <Text>
            {t(
              `You're now ready to migrate all your LPs from external DEXs into CosmicX to earn new yields. What are you waiting for!?`,
            )}
          </Text>
          <Text sx={{ fontStyle: 'italic', fontWeight: 300 }}>
      ...
      slideContent={
        <>
          <Text sx={{ lineHeight: '22px' }}>
            {t('CosmicX has updated the smart contracts to implement the new ')}
            <Text sx={styles.yellow}>
              <a
                href="https://vote.cosmicx.finance/#/proposal/0x7c816da506f35d6932cf759faf81b221d566942d9472111fb795ab63150760a9"
                target="_blank"
                rel="noreferrer noopener"
              >
                {t('Hard Cap')}
            ...
            {t(
              `. Users staking in CosmicX products must migrate their assets to the new MasterApeV2 contract to continue earning rewards.`,
            )}
          </Text>
  ...
  return [
    <Slide
      ...
      slideContent={
        <Text>
          {t(
            `Do not enter CosmicX through search engines, Google Ads, or any links shared through social media like Telegram or Twitter. Always make sure you\'re at the correct URL (`,
          )}
          <Text sx={{ fontWeight: 700 }}>cosmicx.finance</Text>
    ...
    <Slide
      ...
      slideContent={
        <Text>
          {t(
            `No one from CosmicX will ever ask you for your wallet keys or seed phrase. Beware of scammers on social media representing themselves as being affiliated with CosmicX or asking you to send them funds.`,
          )}
        </Text>
      }
    />,
    <Slide
      ...
      slideContent={
        <Text>
          {t(
            `Before buying any tokens or using any products offered by CosmicX, always do your own research. Make sure you read the documentation and tutorials to understand each product.`,
          )}
        </Text>
      }
    />,
      ...
      slideContent={
        <>
          <Text>
            ...
            {t('to connect your wallet to CosmicX.')}
          </Text>
          <Text sx={{ fontStyle: 'italic', fontWeight: 300 }}>
