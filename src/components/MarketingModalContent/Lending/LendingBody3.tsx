...
const LendingBody3: React.FC = () => {
  return (
    <ModalContent Icon={<StyledLendingM3Icon />}>
      <RightContent>
        <StyledText>
          Both suppliers and borrowers can earn COSMIC rewards from the Rainmaker, depending on the market. <br />
          COSMIC rewards are independent of interest earned/owed.
        </StyledText>
      </RightContent>
    </ModalContent>
  )
